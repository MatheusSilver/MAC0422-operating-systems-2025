...
CONTEUDO_ESPERADO=(uspsh.c uspsh.h ep1.c ep1.h LEIAME Makefile entrada-esperado.txt entrada-inesperado.txt slides-ep1.pdf)

#Configurações da Pasta e do nome do EP.
NUM_EP="1" #Alterar isso conforme o número do EP
